...
void main()
{
   ...
   printf("\n\t\t\t\t\t~~~~~~~~~~~~~ WELCOME TO OUR MANAGEMENT DASHBOARD ~~~~~~~~~~~~~");
    printf("\n\n\n\n\n");
    printf("\t\t\t\t\tSign in to access system\n\n");
    while (8)
    {
wrong_id:
       printf("\t\t\t\t\t\tENTER USER ID: ");
        ...
        if(strcmp(id,"rana")==0 || strcmp(id,"jahir")==0 ||strcmp(id,"abdullah")==0 ||strcmp(id,"aman")==0 ||strcmp(id,"group2")==0 )
        {
wrong_pass:
            ...
            pass[i]='\0';
            if(strcmp(pass,"12345")==0 ||strcmp(pass,"rana")==0)
            {
                break;
            }
            else
            {
                printf("\n\t\t\tYWARNING! Wrong Password. Try again\n");
                printf("\n\n");
                goto wrong_pass;
...
w:
                ...
                while(fread(&p,recsize,1,fp)==1)
                {
                    ...
                    {
                        i=1;
                        printf("\n\t\tAPPOINTMENT NUMBER ALREADY EXISTS. ENTER ANOTHER ONE");
                        goto w;
                    }
                }
...
u:
                ...
                while(fread(&s,recsize1,1,fs)==1)
                {
                    ...
                    {
                        iF=1;
                        printf("\n\t\tREGISTRATION NUMBER ALREADY EXISTS. ENTER ANOTHER ONE");
                        goto u;
                    }
                }
